...
export function Cabecalio() {
    return(
        <div class="cabecalio">
            ...
            <form>
                <input type="text" id="pesquisa"  class="form-control pesquisa-control search-bar"></input>
                <label for="pesquisa" class="form-label pesquisa-label" id="search-icon" onclick="toggleSearch()">
