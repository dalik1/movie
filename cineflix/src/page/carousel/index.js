...
function CarouselInner(){
    return(
        <div class="carousel-item active" data-bs-interval="10000" >
            ...
            <img class="films col-3 mid-sai" src="https://www.themoviedb.org/t/p/w1280/miif4N3YWL5mGGlXA2YrHPr2iwz.jpg" alt="Duna"/>
            <iframe class="video" src="https://www.youtube.com/embed/ncwsW3qxQlo" title="Duna: Parte 2 | Trailer Oficial 3" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
    )
}